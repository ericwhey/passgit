 ...
 * @author Eric Hey
 */
public class CopyPasswordToClipboardAction extends AbstractAction {
    
    private final Controller controller;
    private PathModel pathModel;
    
    public CopyPasswordToClipboardAction(Controller controller) {
        super("Copy Password");
    ...
    public void actionPerformed(ActionEvent e) {
        controller.copyPasswordToClipboard(pathModel);
    }
